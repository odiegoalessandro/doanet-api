...
public class DonationConfig {
  ...
  @Bean
  public FindAllDonationsUseCase findAllDonationsUseCase(DonationRepository donationRepository) {
  ...
  @Bean
  public FindDonationByDonorIdUseCase findDonationByDonorIdUseCase(
      DonationRepository donationRepository) {
  ...
  @Bean
  public FindDonationByStatusUseCase findDonationByStatusUseCase(
      DonationRepository donationRepository) {
  ...
  public UpdateStatusDonationUseCase updateDonationStatusUseCase(
      ...
      RecordAuditUseCase recordAuditUseCase) {
    return new UpdateStatusDonationUseCase(
        donationRepository, findDonationByIdUseCase, recordAuditUseCase);
  }
  ...
  public UpdateDonationItemsUseCase updateDonationItemsUseCase(
      ...
      FindDonationByIdUseCase findDonationByIdUseCase,
      FindItemByIdUseCase findItemByIdUseCase) {
    return new UpdateDonationItemsUseCase(
        donationRepository, findDonationByIdUseCase, findItemByIdUseCase);
  }
  ...
  public DonationRepository donationRepository(
    ...
    return new DonationRepositoryImpl(
        donationEntityMapper, jpaDonationRepository, jpaItemRepository);
  }
}
