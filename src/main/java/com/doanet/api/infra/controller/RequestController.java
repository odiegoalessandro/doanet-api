...
@Tag(name = "Requests", description = "Operações relacionadas aos pedidos")
public class RequestController {
  ...
  public ResponseEntity<ApiSuccessResponse<PageResponse<RequestDto>>> findAll(
    ...
    var response = new ApiSuccessResponse<>(HttpStatus.OK, "Lista de pedidos retornada com sucesso",
  ...
  public ResponseEntity<ApiSuccessResponse<PageResponse<RequestDto>>> findByDonationPointId(
    @PathVariable Long donationPointId,
    @RequestParam int pageNumber,
    @RequestParam int pageSize
  ) {
    var page = findRequestByDonationPointIdUseCase.execute(donationPointId, pageNumber, pageSize);
    var items = page.content().stream().map(this::mapToDto).toList();
    var response = new ApiSuccessResponse<>(HttpStatus.OK, "Pedidos encontrados",
      new PageResponse<>(items, page.totalElements(), page.totalPages(), page.currentPage()));
    return ResponseEntity.ok(response);
  }
  // TODO: atualizar o contrato da API para incluir um schema preciso
  ...
  public ResponseEntity<ApiSuccessResponse<PageResponse<RequestDto>>> findByOngId(
  ...
  public ResponseEntity<ApiSuccessResponse<PageResponse<RequestDto>>> findByStatus(
  ...
  public ResponseEntity<ApiSuccessResponse<RequestDto>> updateItems(
    @PathVariable Long id,
    @RequestBody @Valid UpdateRequestItemsCommand command
  ) {
  ...
  public ResponseEntity<ApiSuccessResponse<RequestDto>> updateStatus(
    @PathVariable Long id,
    @RequestParam RequestStatus status
  ) {
